...
angles_computer_python_1.1.py --vec1="A1 A2" --vec2="A3 A4" -s file.tpr -f traj.xtc -o outputname
...
for ts in u.trajectory:
  ...
  Ts.append(ts.time)
  f=open("angles_"+outputname+".dat", 'a')                     #open the file with append option
...
pyp.savefig("angles_"+outputname+".png")			#saves the figure
